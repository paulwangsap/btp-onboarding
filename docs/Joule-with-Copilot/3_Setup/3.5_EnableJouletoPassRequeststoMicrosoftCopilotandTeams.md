...
1. Open a text editor and copy this URL: https://login.microsoftonline.com/{tenant_id}/v2.0/adminconsent?client_id=6c4ffae2-1232-41f6-9fd5-d35af58ed1ac&scope=6c4ffae2-1232-41f6-9fd5-d35af58ed1ac/.default
...
<p align="center">
   <img src="assets/20251210_093908_MichaelShea_1-1762348115565.png" alt="Description" width="500")
</p>
...
2. Choose your federation app.
   ...
   <p align="center">
      <img src="assets/20251210_094313_image.png" alt="Description" width="500")
   </p>
...
4. Choose **Add a permission** .
   ...
   <p align="center">
      <img src="assets/20251210_094409_image.png" alt="Description" width="500")
   </p>
...
6. Choose **svc-ai-joule-copilot-api-access** .
   ...
   <p align="center">
      <img src="assets/20251210_094519_image.png" alt="Description" width="500")
   </p>
...
9. Choose **Add permissions** .
   ...
   <p align="center">
      <img src="assets/20251210_094618_image.png" alt="Description" width="500")
   </p>

   Notice the new entry for **svc-ai-joule-copilot-api-access**. Permissions aren't granted yet.

   <p align="center">
      <img src="assets/20251210_094657_image.png" alt="Description" width="500")
   </p>
   
10. Choose **Grant admin consent for** ***{Entra_ID_Tenant_Name}*** and choose **Yes** .

   <p align="center">
      <img src="assets/20251210_094802_image.png" alt="Description" width="500")
   </p>

11. :exclamation:Verify that the status for **svc-ai-joule-copilot-api-access** has changed to **Granted** .

   <p align="center">
      <img src="assets/20251210_094836_image.png" alt="Description" width="500")
   </p>
