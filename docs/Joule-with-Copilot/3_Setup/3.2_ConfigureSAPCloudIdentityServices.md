...
2. Under **Provider Configuration** , enter the following:
   ...
   | Name                      | Federation with Entra ID<br />**Note:** The value of this field must the same as the **Value** field configured in the federated credential in Microsoft Entra ID. If you leave this field empty, the system will enter the value for you when you load the configuration later in this procedure. |
