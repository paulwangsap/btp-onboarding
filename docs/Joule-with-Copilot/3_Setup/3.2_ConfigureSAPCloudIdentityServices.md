...
2. Choose **Create**.
   ...
   <p align="center">
      <img src="assets/20251126_125929_MichaelShea_0-1747831285171.png" alt="Description" width="800")
   </p>
...
4. Choose **Create** .
   ...
   <p align="center">
      <img src="assets/20251126_125948_MichaelShea_1-1747831285172.png" alt="Description" width="400")
   </p>
...
3. Save your entries.
   ...
   <p align="center">
      <img src="assets/20251126_130223_MichaelShea_0-1747832032727.png" alt="Description" width="800")
   </p>
...
3. Enable **Allow Identity Authentication users only** .
   ...
   <p align="center">
      <img src="assets/20251126_130123_MichaelShea_1-1747832445763.png" alt="Description" width="800")
   </p>
...
2. Under **Provider Configuration** , enter the following:
   ...
   | **Field**                 | **Value**                                                                                                                                                                                                                                                                           |
   | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | Discover URL              | {entraid_issuer}/v2.0                                                                                                                                                                                                                                                         |
   | Name                      | Federation with Entra ID. The value of this field must the same as the**Value** field configured in the federated credential in Microsoft Entra ID. If you leave this field empty, the system will enter the value for you when you load the configuration later in this procedure. |
...
7. Save your entries.
   ...
   <p align="center">
      <img src="assets/20251126_130356_MichaelShea_0-1747832732149.png" alt="Description" width="800")
   </p>
...
2. Sign on with a user with an admin role.
   ...
   <p align="center">
      <img src="assets/20251126_130434_MichaelShea_0-1747836563730.png" alt="Description" width="400")
   </p>
   <p align="center">
      <img src="assets/20251126_130443_MichaelShea_1-1747836563731.png" alt="Description" width="400")
   </p>
3. :exclamation:Verify the success of the validation.
   ...
   * **Step 3 – TokenVerification** shows Success.
     ...
     <p align="center">
         <img src="assets/20251126_130625_MichaelShea_2-1747836563736.png" alt="Description" width="800")
      </p>
