...
* Choose **Conditional Authentication** .
      ...
      <p align="center">
      <img src="assets/20251126_130946_MichaelShea_0-1747837154308.png" alt="Description" width="500")
      </p>

* Option 1 (Recommended option): Setup Conditional Authentication for Joule

  1. Choose **Add Rule** .

      <p align="center">
        <img src="assets/20251126_131131_MichaelShea_1-1747837154317.png" alt="Description" width="500")
      </p>
      
  2. Under **Identity Provider** , choose **Federation with Entra ID** **.**
  3. :exclamation:In **Email Domain** , enter the email domain of the users in your Microsoft Entra ID.
  4. Choose **OK** .
  5. Save your entries.
     Verify that there is a new rule for your identity provider.

    <p align="center">
      <img src="assets/20251126_131205_MichaelShea_2-1747837154326.png" alt="Description" width="500")
    </p>

  **Note:** If you have multiple email domains, repeat steps 1-5 for each domain.
* Option 2: Set Microsoft Entra ID as the Default Authenticating Identity Provider

  1. In the **Default Identity Provider ** field, choose **Federation with Entra ID** .

    <p align="center">
      <img src="assets/20251126_131103_option1.png" alt="Description" width="500")
    </p>
    
  2. Save your entries

    <p align="center">
      <img src="assets/20251126_131239_option2.png" alt="Description" width="500")
     </p>

Recap: Configure Microsoft Entra ID as Joule’s identity provider in SAP Cloud Identity Services by setting up either conditional authentication for specific email domains (recommended) or making Entra ID the default provider for all users.
