...
## 6. SAP Joule in Microsoft Teams throws "underfined" error


## 7. Error while Synchronizing - Unique constraint voilated
...
## 9. Error - SAP Joule does not seem to be set up for your tenant. Please contact your administrator to check the prerequisites and set up the integration.
